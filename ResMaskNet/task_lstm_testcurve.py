...
for task, videos in task_to_videos.items():
    ...
    for test_video in videos:
        ...
        # Compute class imbalance from TRAIN DATA ONLY
        ...
        writer = SummaryWriter(
            log_dir=f"runs/task_lstm_testcurve_overlap/{task}/{test_video.replace('/', '_')}"
        )
...
predictions_df.to_excel("task_lstm_video_predictions.xlsx", index=False)

print("Saved video predictions to: task_lstm_video_predictions.xlsx")
