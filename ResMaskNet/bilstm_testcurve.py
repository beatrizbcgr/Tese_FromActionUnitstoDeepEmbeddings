...
# ============================================================
# TRAIN FUNCTION (TRAIN LOSS + TEST ACC LOGGING)             
# ============================================================
def train_one(train_loader, scale, test_videos, subject_id,
              max_epochs=100, patience=40):

    model = BiLSTM(input_size=X.shape[2]).to(device)
    ...
    writer = SummaryWriter(log_dir=f"runs/lstm_train_and_test_curves/{subject_id}")
