...
def train_model(train_loader, input_size, writer):
    ...
    for task in tasks:
        ...
        for test_subject in subjects:
            ...
            writer = SummaryWriter(
                log_dir=f"runs/au_emb_task_pca/{n_comp}/{task}/{test_subject}"
            )

            model = train_model(train_loader, X_fused.shape[2], writer)
            model.eval()
